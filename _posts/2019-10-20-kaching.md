...
But TLA can't create runnable systems. Bridging the gap between verification models and runnable code is something we have yet to see in industrial languages, and would be a good improvement.
...
The good news is that distributed programming knowledge, including cache design, are diffusing through the landscape. We'll see more tricks for preventing these failure, both built into our languages and pounded into our brains. And eventually even in our job descriptions.
