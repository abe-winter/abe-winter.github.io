...
You don't choose an AMP cache, [it chooses you](https://amp.dev/documentation/guides-and-tutorials/learn/amp-caches-and-cors/how_amp_pages_are_cached/#how-do-i-choose-an-amp-cache?):
...
Because Google's search rankings have a performance component,
and newsrooms rely on search for traffic,
and news websites are legitimately janky and slow, 
Google was able to turn their 'improve your website speed or drop in rank' mandate
into a sales pitch:
speed up your site by any means necessary, like maybe our AMP CDN thing, or drop in rank.
