...
Policing is generally about wandering around physical on streets *or* about seeing someone on a camera so you can catch them later.
Robots, it turns out, are getting good at both of these tasks.
...
This is, I guess, better than having people carry around weapons that *aren't* locked.
...
* 'Am I under arrest or am I free to go / if you don't submit to a search we'll arrest you / arrest me for what / tresspassing' (this went on for an hour, I missed a flight, and I missed my cousin's wedding)
* 'Why are you calling the bomb squad / you tested positive for accelerant / is there any other explanation / you could have been on a freshly fertilized lawn'. (In this one I was invited to get a 'private room crotch rub' which I politely declined)
...
I don't know the rules, some of what the cops said is potentially wrong, and these interactions are happening hundreds of times per day with no record.
I've always wanted a panic button so these conversations would be on the record.
What I *really* want is cheap, live advice.
Or better yet, a script.
...
If you're an agency that employs law enforcement officers and someone asks 'are there limits to your authority' and you say 'not really',
I believe that private groups like the ACLU will disrupt your power by combining panic buttons + arrest scripts to fill the 'norm vacuum'.

## Camouflage

Surveillance is cheap and getting cheaper --
we have more cameras and better software for saying what's on them.
...
At least today, [adversarial fashion](https://boingboing.net/2019/08/10/chaffing-the-alprs.html) designed to fool license plate readers *isn't* banned.
...
Under what circumstances will it be permitted to send a signal that *destroys* a camera or device if the signal is intended to deter unlawful private surveillance.
...
I think making the city street a conflict zone will have a wider impact; it won't just affect the technology we carry, it will bend back the curve of urbanization.
...
Propublica got a list of risk scores from 7+ thousand arrestees near Fort Lauderdale and claimed that it mislabeled black arrestees 2x more than whites.
...
(A lot has changed since then though; Winnie the Poo wasn't on anyone's radar and the [Grass Mud Horse](https://en.wikipedia.org/wiki/Grass_Mud_Horse) was still fresh).
...
I can imagine more effective surveillance networks (beyond what's feasible today) being used to watch speech and decide at what threshold to intervene;
intervening in ways that push the boundaries of the law at exactly the right moment.
(Although I hate this kind of thing, I also recognize that there's social good in intervening at the point where speech turns to violence, rather than after).

Sentiment isn't just something you can measure.
...
Think of all the ways a smart police department could use this.
...
This probably isn't possible for individuals (we're busy enough), but a political group might do it -- 'we vote as a block, let's collect our different personalization and see how'.
Facebook apparently hates this kind of thing because they [blocked some ad surveillance tools in 2018](https://www.propublica.org/article/facebook-blocks-ad-transparency-tools).
(But [propublica / quartz are back in the game with this](https://projects.propublica.org/facebook-ads/) somehow).

Another answer is 'never log into anything' and don't trust anything that makes you log in.
...
(I ran a survey on this and am running more -- more people understand encryption than I thought, more care about it, and I think it's a bipartisan issue).

A retired philly cop was [released after 4 years on jail](https://arstechnica.com/tech-policy/2020/02/man-who-refused-to-decrypt-hard-drives-is-free-after-four-years-in-jail/) for refusing to decrypt a hard drive full of child porn that he'd shown to an undercover fed I think.
...
If that party is the plaintiff in a criminal trial, they could just as easily sign a fake image.

## Future of legitimacy

It's easy to focus on 'how do you enforce' and ignore the 'should we enforce'.
I think IP law made this transition between napster and youtube -- I think that 5 years earlier, viacom's lawsuit against youtube would have succeeded and YT would have been buried in equitable damages.
...
Cheaper policing is the opposite: it gives us the option to write a ton of shiny *new* laws because our enforcement technology will get so good.
...
the fact that we *can* still enforce rules using technology doesn't mean that we should, or that the rules are good.

I don't have an answer for how to prevent this, but we need one.
