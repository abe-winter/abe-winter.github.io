...
The stigmergic excreta masquerading as the rules, settings and instructions of these platforms have no relationship to how they actualy function.
Rather than treating any textual cue on their website as guidance, I should have remembered this graffiti'd footnote to the turnoff for a Columbia BC logging trail:
> google maps sent you here to die.
In other words, get advice from experts, and when something goes wrong, get somebody on the phone.
