...
[^mullet]: Jonah Perretti (of BuzzFeed + HuffPo), mullet / viralness slideshow, via [boing boing](https://boingboing.net/2010/08/13/how-to-engineer-a-vi.html). Note slide 4 which says you can rule the internet by subscribing to my blog.
...
When Twitter banned Aaron Rupar, the [appeal button was broken](https://aaronrupar.substack.com/p/aaron-rupar-twitter-suspension-elon-musk).
...
If there's an AI in charge the AI is Loab, the incarnation of the internet's suppressed id.
...
The second call wasn't the amazing thing either.
What happened was that I got phished.
...
It contained a non-hyperlinked link to a random facebook post for an 'IP Enforcement' page, which in turn linked to meta oversight dispute dot com (or something), which was a copy of their help page but none of the links worked.
...
*I've* been blocked, but apparently it's okay to impersonate facebook's entire support site to harvest, I am guessing, credit cards?
...
The main advice I got from marketing friends who I pestered about this whole chain of events is 'yeah that happens a lot', pause, remember what year it is, 'why are you on facebook'.

Eventually I tried doing a boosted post on instagram and had the same experience -- it ran for like a second and then got taken down.
I don't know why.
My browser can't log in to fb and insta at the same time, and the admin dashes have gotten even more complicated since adding the insta account, and I don't have the energy.

I finally read the cold start problem and convinced myself I shouldn't be sourcing users from social yet.

I wanted the point of this article to be 'I'm in the internet's middle class, I pay my taxes, and I deserve better'.
But am I?
