...
Singapore had early success with bluetooth-based contact tracing (TraceTogether), which they opened up as bluetrace, [whitepaper here](https://bluetrace.io/static/bluetrace_whitepaper-938063656596c104632def383eb33b3c.pdf). Some takeaways from that:
...
One alternative is check-ins. Check-ins the way foursquare does it *aren't* very private (they're designed for sharing), but you could do it with most of the information kept private on the phone until you test positive, and send down a list of venues rather than individual IDs.
