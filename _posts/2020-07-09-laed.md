---
layout: post
title: LAED loopholes: unafilliated entities, on-device data
author: Abe Winter
...
This is mostly a read-through for my benefit . The interesting parts are the 'unafilliated entity' discussion and the apparent 'local data' loophole for OSs (see 'remote data only' section).
