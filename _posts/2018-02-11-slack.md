...
There's one way in which slack edges out trello & jira for project managemnet. T&J don't implement backpressure; slack does, because there are limits to attention.
...
Slack and the toxic behaviors it implicitly endorses will gives ADD to your *whole company*. Want a one-click competitive advantage? Delete your account.
